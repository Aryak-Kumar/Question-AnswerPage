...
<div class="topnav">
  <a class="logo" href="#home"><img width="100px" src="logo.png"></a>
  <div class="space-ar">
  <div class="search-container">
    <form action="/action_page.php">
      <input type="text" placeholder="Search..." name="search">
      <button type="submit"><img height="20px" src="search.png"></button>
    </form>
  </div>&nbsp;&nbsp;
...
<br><a  href="index.php"><button class="back">Back</button></a>
...
<button type='submit' name='co_up' value = 'upvote1' class='upvotes-button' >
    <img width='40px' id='upvote' class='upvotes no-up'></button>";
