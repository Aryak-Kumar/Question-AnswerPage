...
<div class="topnav" id='top'>
  ...
  <a href="login.php" ><button class="log">Log in</button></a> &nbsp;&nbsp;
  <a href="register.php" ><button class="log">Register</button></a> &nbsp;&nbsp;
</div>
</div>
...
$upvotes = mysqli_query($con,"SELECT * FROM Answers where qid=$qid");
  $a=0;
  while($row2 = mysqli_fetch_array($upvotes)){
    $a++;
}
...
echo "<button name='co_up' value = 'upvote1' class='upvotes-button'>
    <img width='40px' id='upvote' class='upvotes no-up'></button><p id='upvotes' style='vertical-align: center; text-align: center;'> <b>".$c."</b> </p>
</div>
 ...
 <div style=' display: flex; flex-direction: column;'>
  ...
  <h1 style='margin: 10px;'><a href='answer1.php?value_key=".$qid."' id='title_lis' style='margin:auto; text-decoration: none; color: black; vertical-align: center; text-align: center;'>".$row['title']."</a></h1>";
...
$j++;}
    ...
    echo "<p style='margin: 20px; font-size: 17px;'>".$row['content']."</p>";
