...
<div class="container">
<form action="qasked.php" method="post">
  <div class="imag">
...
<h1 align="center">Ask Your Question</h1>
  <div class="cont">
    ...
    <input id="tit" type="text" placeholder="Title" name="title" required>
  </div>
  <br>
  <div >
...
<div class="inp">
    ...
    <textarea name="cont" rows="4" style="width: 100%; font-size: 12px;" required></textarea>
        </div><br>
